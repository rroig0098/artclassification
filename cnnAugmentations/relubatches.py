...
board = keras.callbacks.TensorBoard(log_dir='./logs/modelnormalizing1119', 
	histogram_freq=0, 
	batch_size=32, 
	write_graph=True)
...
train_generator = train_datagen.flow_from_directory('/home/rroig98/CollectionsofArt/trainSet', 
	target_size = (500, 500), 
	batch_size = batch_size, 
	class_mode = 'categorical', 
	color_mode='rgb',
	interpolation = 'nearest', 
	save_to_dir='/home/rroig98/CollectionsofArt/visualTrain',
	save_format='jpeg')


v_generator = test_datagen.flow_from_directory('/home/rroig98/CollectionsofArt/testSet', 
	target_size = (500,500), 
	batch_size = batch_size, 
	class_mode = 'categorical', 
	color_mode='rgb',
...
model.save_weights('modelnormalizing1119.h5')
